...
export const ArrowBackIcon = createIcon({
  ...
  path: (
    ...
    >
      <path
        d="M14.999 19L8.99902 12L14.999 5"
        stroke="#292929"
        strokeWidth="2"
        strokeLinecap="round"
...
export const MarketAddressIcon = createIcon({
  ...
  path: (
    ...
    >
      ...
      <path
        d="M13 7C13 9.76142 9.59415 13.9741 8 13.9741C6.40585 13.9741 3 9.76142 3 7C3 4.23858 5.23858 2 8 2C10.7614 2 13 4.23858 13 7Z"
        stroke="#707070"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export const ErrorPageIcon = createIcon({
  ...
  path: (
    ...
    >
      ...
      />
      <path
        d="M64.5536 55.644L63.9936 69.056H59.9336L59.3736 55.644H64.5536ZM62.0336 76.224C61.1936 76.224 60.5029 75.9813 59.9616 75.496C59.4389 74.992 59.1776 74.376 59.1776 73.648C59.1776 72.9013 59.4389 72.276 59.9616 71.772C60.5029 71.268 61.1936 71.016 62.0336 71.016C62.8549 71.016 63.5269 71.268 64.0496 71.772C64.5909 72.276 64.8616 72.9013 64.8616 73.648C64.8616 74.376 64.5909 74.992 64.0496 75.496C63.5269 75.9813 62.8549 76.224 62.0336 76.224Z"
        fill="#999999"
      />
    </svg>
  ),
